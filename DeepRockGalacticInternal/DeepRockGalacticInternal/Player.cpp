...
//
//	pCharacter = (Character*)Hack::FindDMAAddy(moduleBase + firstOffset_GameData, { 0x0, 0x20, 0x0 });
//
//	pLast = pCharacter;
//}
//
...
//	uint32_t FNameIndex = 0x0; // pCharacter->pWeaponData->pCurrentWeapon->FNameIndex;
//	if (FNameIndex < 1)
//	{
//		return Name;
//	}
